...
btnChart1 = tk.Button(window, text="График 1", font = ('Helvetika', 10, 'bold'), command=chart1.plot_chart)
...
btnChart2 = tk.Button(window, text="График 2", font = ('Helvetika', 10, 'bold'), command=chart2.plot_chart)
...
btnChart3 = tk.Button(window, text="График 4", font = ('Helvetika', 10, 'bold'), command=chart2.plot_chart2)
...
btnChart4 = tk.Button(window, text="График 5", font = ('Helvetika', 10, 'bold'), command=chart2.plot_chart3)
btnChart4.place(x=40, y=315, width=90, height=30)

lblChart3 = tk.Label(text = "Нормальное распределение - 4 графика")
...
btnChart3 = tk.Button(window, text="График 7", font = ('Helvetika', 10, 'bold'), command=chart5.plot_chart2)
btnChart3.place(x=40, y=415, width=90, height=30)

lblChart3 = tk.Label(text = "Сдвоенная гистограмма Seaborn")
